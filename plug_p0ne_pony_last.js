 ...
 */
var p0ne_, errors, warnings, ref$, out$ = typeof exports != 'undefined' && exports || this, slice$ = [].slice;
...
(function(p0neInit){
  ...
  p0neInitWrapper2 = function(){
    ...
    try {
      if (that = window.indexedDB || window.webkitIndexedDB || window.mozIndexedDB || window.OIndexedDB || window.msIndexedDB) {
        ...
        x$.onerror = x$.onblocked = function(err){
          ...
          console.error("[p0ne init] indexDB doesn't work, falling back to localStorage", err);
          p0neInitWrapper();
        };
      } else {
        p0neInitWrapper();
  ...
  if (!(v = localStorage.p0neVersion) || compareVersions(v, p0ne.lastCompatibleVersion)) {
    p0neInitWrapper2();
  } else {
    ...
    API.on('p0ne_migrated', onMigrated = function(newVersion){
      if (compareVersions(newVersion, p0ne.lastCompatibleVersion)) {
        API.off('p0ne_migrated', onMigrated);
        p0neInitWrapper2();
      }
    });
    $.getScript(p0ne.host + "/scripts/plug_p0ne.migrate." + v.split('.')[0] + ".js?from=" + v + "&to=" + p0ne.version);
  }
})(function(){
  /* start of fn_ */
  ...
  */
  ...
  importAll$(window, {
    ...
    getUser: function(user){
      ...
      if (+user) {
        ...
        for (i$ = 0, len$ = userList.length; i$ < len$; ++i$) {
          u = userList[i$];
          if (u.username.toLowerCase() === user || ((ref$ = u.rawun) != null ? ref$.toLowerCase() : void 8) === user) {
            return u;
          }
        }
      } else {
    ...
    getMentions: function(data, safeOffsets){
      ...
      data.message.replace(/@/g, function(_, offset){
        var possibleMatches, i, possibleMatches2, l2, i$, len$, m, str, k, ref$, v, genericMatch, res;
        offset++;
  ...
  return dataLoadAll({
    ...
    'use strict';
    var id, ref$, m, moduleName, cdnHost, ref1$, InventoryDropdown, ref2$, Dialog, PlaylistItemRow, PlaylistMediaList, i$, len$, context, ref3$, ref4$, cb, app, friendsList, search, pl, user, ref5$, ev, myAvatars, userID, k, v, ref6$, e, MediaCollection, $cm, rR_, onLoaded, dummyP3, ppStop, MAX_IMAGE_HEIGHT, CHAT_WIDTH, tmp, ref7$, ref8$, ref9$;
    ...
    window.Cells = [];
    delete window.room, delete window.search;
    for (id in ref$ = require.s.contexts._.defined) {
      m = ref$[id];
      if (m) {
        moduleName = false;
        ...
        case !m.scThumbnail:
          moduleName = 'plugUrls';
          out$.cdnHost = cdnHost = parseURL(m.scThumbnail).host;
          break;
    ...
    for (i$ = 0, len$ = (ref$ = (typeof room != 'undefined' && room !== null ? (ref2$ = room._events) != null ? ref2$['change:name'] : void 8 : void 8) || (typeof _$context != 'undefined' && _$context !== null ? (ref3$ = _$context._events) != null ? ref3$['show:room'] : void 8 : void 8) || (typeof Layout != 'undefined' && Layout !== null ? (ref4$ = Layout._events) != null ? ref4$['resize'] : void 8 : void 8) || []).length; i$ < len$; ++i$) {
      ...
      if (cb.ctx.room) {
        ...
        out$.search = search = app.footer.playlist.playlist.search;
    ...
    if ((typeof Media != 'undefined' && Media !== null) && (typeof Backbone != 'undefined' && Backbone !== null)) {
      out$.MediaCollection = MediaCollection = Backbone.Collection.extend({
        model: Media
      });
    }
      ...
      try {
        ...
        helperFNs = {
          ...
          replace: function(target, attr, repl){
            ...
            target[attr] = repl;
            (ref$ = cbs.replacements || (cbs.replacements = []))[ref$.length] = [target, attr, repl, orig];
            return repl;
          },
          ...
          enable: function(){
            ...
            try {
              ...
              console.info(getTime() + " [" + moduleName + "] enabled");
            } catch (e$) {
              err = e$;
    ...
    module('PopoutListener', {
      ...
      setup: function(arg$){
        ...
        wrap(PopoutView, 'render', function(r_){
          return function(){
            $ad = chat.$chatMessages.children('.adsense').detach();
            console.info($ad);
        ...
        if (songList != null && songList.length) {
          if (songList[0] || !(((ref$ = songList.models) != null ? ref$[0] : void 8) instanceof Media)) {
            ...
            for (i$ = 0, len$ = songList.length; i$ < len$; ++i$) {
              ...
              if (m.id = ~0) {
                delete m.id, delete m.attributes.id;
              }
              res.add(m);
            }
            return res;
    ...
    module('customEmoji', {
      ...
      setup: function(arg$){
        ...
        this.css('customEmoji', '.emoji-outer.emoji-sizer {width: auto;height: auto;}span.emoji-inner {width: 16px;height: 16px;}');
      ...
      addEmoji: function(name, url, options){
        var name, emojis, ref$, style, i$, len$, k, v, s;
        ...
        for (name in emojis) {
          ...
          if (!emoji.plugdata.has(name)) {
            ...
            (ref$ = emoji.plugdata)[ref$.length] = name;
          }
          style = "background: url(" + options.url + ");";
          if (options.size) {
          ...
          this.css("customEmoji-" + name, "#app .emoji-inner.gemoji-plug-" + name + " {" + style + "}#chat-suggestion-items .gemoji-plug-" + name + " {background-size: 16px;width: 16px;height: 16px;}");
        }
      },
    ...
    module('socketListeners', {
      ...
      optional: ['_$context', 'auxiliaries', 'socketReconnectEvent'],
      setup: function(arg$, socketListeners){
        var addListener, replace, wrap, revert, socket, onRoomJoinQueue2, patchSocket, patchedSend, syncPatchSocket, this$ = this;
        ...
        wrap(WebSocket.prototype, 'send', function(send_){
          patchSocket = function(s){
            out$.socket = socket = s;
            replace(s, 'onmessage', patchedOnMessage);
            replace(s, 'emit', emit);
            if (typeof _$context != 'undefined' && _$context !== null) {
              _$context.trigger('p0ne:socket:patched', socket);
            }
            API.trigger('p0ne:socket:patched', socket);
          };
          return patchedSend = function(data){
            send_.call(this, data);
            if (this !== socket && this.url.has('plug.dj') && parseURL(this.url).hostname.endsWith('.plug.dj')) {
              patchSocket(this);
            }
          };
        });
    ...
    module('fixGhosting', {
      ...
      setup: function(arg$){
        var wrap, addListener, _settings, rejoining, queue, rejoinRoom;
    ...
    */
    ...
    module('fixTimeStamps', {
      ...
      setup: function(arg$){
        var replace;
        replace = arg$.replace;
        replace(auxiliaries, 'convertChatTimestamp', function(){
    ...
    */
    ...
    module('streamSettings', {
      ...
      setup: function(arg$, streamSettings, m_){
        var addListener, replace, wrap, revert, replaceListener, $create, css, $playback, $playbackContainer, $el, playback, $btn, $label, $icons, disabledBtns, Player, audio, unblocker, i$, ref$, youtube, sc, DummyPlayer, noDJ, syncingPlayer, streamOff, snoozed, m, player, this$ = this;
        ...
        Player = {
          ...
          seek: function(){
            ...
            if (player !== this) {
              ...
              console.log("[StreamSettings] " + this.name + " seekingâ€¦", mediaTime(startTime));
            } else {
              this.play();
            }
          },
        ...
        unblocker.getURL = function(media){
          ...
          mediaDownload(media).then(function(d){
            ...
            if (blocked === 2) {
              chatWarn("failed, trying againâ€¦", "YT Unblocker");
              refresh();
            } else {
        ...
        youtube = (ref$ = clone$(Player), ref$.name = "Video", ref$.mode = 'video', ref$.iframeUrl = "//plgyte.appspot.com/yt5" + (
          location.host == 'plug.dj'
          ? ''
          : location.host == 'localhost'
          ? 'local'
          : 'staging'
        ) + ".html", ref$.enable = function(media){
          var startTime;
          this.media = media;
          ...
          $("<iframe id=yt-frame frameborder=0 src='" + this.iframeUrl + "'>").load(playback.ytFrameLoadedBind).appendTo(playback.$container);
        ...
        syncingPlayer = (ref$ = clone$(DummyPlayer), ref$.name = "waitingâ€¦", ref$.mode = 'off', ref$.enable = function(){
        ...
        changeStream(player);
        replace(Playback.prototype, 'onVolumeChange', function(arg$, vol){
        ...
        wrap(Playback.prototype, 'reset', function(r_){
          return function(){
            if (database.settings.streamDisabled) {
              changeStream(streamOff);
            }
        ...
        replace(Playback.prototype, 'onYTPlayerError', function(e){
        ...
        /*replace Playback::, \onRefreshClick, !->
        ...
        if (app != null) {
          ...
          wrap(Playback.prototype, 'onRemainingChange', function(oMC_){
            return function(){
              streamSettings.playback = playback = this;
      ...
      commands: {
        commands: {
          ...
          callback: function(){
            ...
            user = API.getUser();
            res = "<div class='msg text'><div class=p0ne-help-command style='color:white'>hover commands to see the full description</div>";
            for (k in ref$ = chatCommands.commands) {
              ...
              if (command && (!command.moderation || user.gRole || (command.moderation === true
                ...
                if ((ref1$ = command.aliases) != null && ref1$.length) {
                  title += "\n" + (command.aliases.length > 1 ? 'aliases' : 'alias') + ": " + humanList(command.aliases);
                }
        ...
        grab: {
          ...
          callback: function(c){
            var pl;
            pl = c.replace(/^\/\w+\s*/, '');
            grabMedia(pl || null, API.getMedia(), !pl).then(function(){
              var pl;
              if (pl) {
                pl = "playlist " + pl;
              } else {
              ...
              chatWarnSmall('', "successfully grabbed to " + pl, "icon-check-blue");
            }).fail(function(err){
              chatWarn("failed to grab. Error: " + err);
            });
          }
        }
        /*away:
          ...
          callback: function(c){
            if (c === '/stream audio') {
              if (!p0ne.modules.streamSettings) {
                chatWarn("can't change to audio-only stream, because Stream Settings couldn't load. Please wait for plug_p0ne to be updated :/", "/stream");
              } else if (p0ne.modules.streamSettings.disabled) {
                chatWarn("can't change to audio-only stream, because Stream Settings are disabled :(<br><button onclick='p0ne.modules.streamSettings.enable();$(this).closest('.cm').remove()'>enable Stream Settings</button>", "/stream", true);
              }
              if ($('.p0ne-stream-buttons .icon-stream-audio').click().length === 0) {
                chatWarn;
              }
            }
            if (typeof currentMedia != 'undefined' && currentMedia !== null) {
              stream(parseToggleArg(c));
            } else {
        ...
        refresh: {
          ...
          description: "enables the stream and refreshes the current song",
          callback: function(){
            if (typeof currentMedia != 'undefined' && currentMedia !== null) {
              stream(true);
            } else {
    ...
    module('autowoot', {
      ...
      setup: function(arg$){
        ...
        addListener = arg$.addListener;
        chatWarn("please consider disabling autowoot, because it's spamming/overloading plug.dj's servers and is reason for some of the very high server costs and instability", this.displayName);
    ...
    module('automute', {
      ...
      module: function(media, isAdd){
        ...
        if (isAdd) {
          if (this.songlist[media.cid]) {
            chatWarnSmall('p0ne-automute-notif p0ne-automute-added', "already automuted " + media.author + " - " + media.title + "'", 'icon-volume-off');
          } else {
          ...
          if (this.songlist[media.cid]) {
            ...
            chatWarnSmall('p0ne-automute-notif p0ne-automute-added', "wasn't automuted " + media.author + " - " + media.title + "'", 'icon-volume-half');
          }
        }
      ...
      settingsPanel: function($el, automute){
        ...
        $el.on('mouseover', '.song-format-2 .load-sc', function(){
          ...
          var $row;
          automute.removeRow($(this).closest('.row').data('cid'));
      ...
      removeRow: function(cid){
        var $row, this$ = this;
        chatWarnSmall('p0ne-automute-notif p0ne-automute-removed', "un-automute " + this.songlist[cid].author + " - " + this.songlist[cid].title + "'", 'icon-volume-half');
    ...
    module('joinLeaveNotif', {
      ...
      setup: function(arg$, arg1$, update){
        ...
        function fn$(event_){
          ...
          addListener(API, event_, function(u){
            ...
            if (u.friend || !this$._settings.onlyShowFriends) {
              event = event_;
      ...
      settingsExtra: function($el){
        var joinLeaveNotif;
        joinLeaveNotif = this;
        $("<form><label><input type=checkbox " + (this._settings.onlyShowFriends ? 'checked' : '') + "> Only friends</label></form>").appendTo($el.css({
          paddingLeft: 15
    ...
    module('etaTimer', {
      ...
      setup: function(arg$){
        ...
        if (typeof roomHistory != 'undefined' && roomHistory !== null) {
          ...
          getAvgDuration = function(p){
            var newestSong, ref$, oldestSong, ref1$, ref2$;
            newestSong = +((ref$ = roomHistory.models[0]) != null ? ref$.attributes.timestamp.split(",")[0] : void 8);
            oldestSong = +((ref1$ = (ref2$ = roomHistory.models)[ref2$.length - 1]) != null ? ref1$.attributes.timestamp.split(",")[0] : void 8);
            return (new Date(newestSong) - new Date(oldestSong)) * p / roomHistory.models.length / 1000;
          };
        } else {
          getAvgDuration = function(p){
            return sum * p / l;
    ...
    module('votelist', {
      ...
      setup: function(arg$, vl){
        ...
        this.onJoin = function(user){
          var r, i$, ref$, u, ru, after, ra;
          this$.$rows[user.id] = $("<div>" + formatUserHTML(u, true, {
            flag: true
          }) + "</div>");
          r = 1 + user.role << user.gRole;
          for (i$ in ref$ = this$.$rows) {
            u = ref$[i$];
            ru = 1 + u.role << u.gRole;
            if (r < ru || r === ru && u.username < user.username) {
              after = u;
              ra = ru;
              break;
            }
          ...
          if (after) {
            for (i$ in ref$ = this$.$rows) {
              u = ref$[i$];
              ru = 1 + u.role << u.gRole;
              if ((r < ru || r === ra && u.username < user.username) && (ra > ru || ra === ru && u.username > after.username)) {
                after = u;
                ra = ru;
              }
            }
            this$.$rows[user.id].insertAfter(this$.$rows[after.id]);
          } else {
            this$.$rows[user.id].prepend(this$.$rows[after.id]);
          }
        };
      ...
      setup: function(arg$){
        ...
        addListener(API, 'p0ne:vote:grab', function(u){
          if (!this$.grabs[u.id]) {
            this$.grabs[u.id] = 1;
            this$.$notifs[u.id] = {
              el: chatWarnSmall('p0ne-grab-notif', formatUserHTML(u, true), 'icon-grab', true)
            };
          } else {
            ...
            addListener API, \advance, (d) !->
                if d.media and d.dj?.id != userID
                    if playlist.list?.rows?.0?.model.cid == d.media.cid  and  getActivePlaylist?
                        chatWarn 'moved down', 'â˜¢ Avoid History Plays'
    ...
    */
    ...
    module('notifyOnLevelUp', {
      ...
      setup: function(arg$){
        ...
        addListener(API, 'p0ne:socket:userUpdate', function(data){
          var ref$, u;
          if (data.level && ((ref$ = u = getUser(data.i)) != null && ref$.friend)) {
    ...
    module('betterChatInput', {
      ...
      setup: function(arg$){
        ...
        css('p0ne_chat_input', '#chat-input {bottom: 10px;height: auto;}#chat-input-field {display: block;position: static;resize: none;height: 30px;overflow: hidden;}.autoresize-helper {display: none;white-space: pre-wrap;word-wrap: break-word;}#chat-input-field, .autoresize-helper {width: 100%;box-sizing: border-box;padding: 7px 10px;min-height: 30px;font: normal normal normal normal 12px / normal Roboto, sans-serif;}/* emote */.p0ne-better-chat-emote {font-style: italic;}');
        chat = window.chat;
    ...
    module('chatPlugin', {
      require: ['_$context'],
      setup: function(arg$){
        var addListener, addClassesCB, ref$;
        addListener = arg$.addListener;
        ...
        addListener('early', _$context, 'chat:receive', function(msg){
          ...
          if (msg.wasAtBottom) {
            ...
            onerror = 'onerror="chatPlugin.imgError(this);chatScrollDown()"';
          } else {
            onload = '';
    ...
    module('gfycatEmbedder', {
      ...
      setup: function(arg$){
        ...
        addListener = arg$.addListener;
        addListener(API, 'p0ne:chat:link', function(arg$){
          var completeURL, domain, onload, onerror, m, ref$;
          completeURL = arg$.completeURL, domain = arg$.domain, onload = arg$.onload, onerror = arg$.onerror;
          if (m = /^https?:\/\/(?:[\w\.]+\.)?gfycat\.com\/(?:detail\/)?(\w+)/.exec(completeURL)) {
            if ((ref$ = m[1]) === 'about' || ref$ === 'jobs' || ref$ === 'partners' || ref$ === 'api' || ref$ === 'terms' || ref$ === 'privacy' || ref$ === 'dmca') {
              return;
            }
    ...
    module('chatImprovedLinkify', {
      displayName: "Improved Linkify",
      settings: 'chat',
      help: 'Improves the automatic link detection.\n\nWith this module, links don\'t necessarily have to start with "http://" or "https://" anymore',
      require: ['chatAuxiliaries', 'Lang', 'plugUrls'],
      setup: function(arg$){
        var replace;
        replace = arg$.replace;
        replace(chatAuxiliaries, 'urlRegex', /\b(?:\w+:\/\/)?(?:[\w:.+-]+@)?(?:[a-z0-9-\u00b7-\u2a6d6]+\.)+[a-z-.\u00b7-\u2a6d6][a-z0-9-.\u00b7-\u2a6d6]{1,24}\b(?::\d+)?(?:[\/?#](?:[^;\s\(\)\[\]]|\([^;\s\(\)\[\]]*\)|\[[^;\s\(\)\[\]]*\])*)?/gi);
        replace(chatAuxiliaries, 'parse', function(str, user, i){
          str = str.fastReplace('--over-max-size--', "[" + Lang.chat.imageMax + "]").fastReplace('--not-found--', "[" + Lang.chat.image404 + "]").fastReplace('--error--', "[" + Lang.errors.error + "]");
          ...
          if (!i) {
            str = str.replace(this.urlRegex, function(url_){
              var url, u, ref$, target;
              if (!/^\w+:/.test(url_)) {
                url = "http://" + url_;
              } else {
                url = url_;
              }
              if (url.has('plug.dj') && (u = parseURL(url)) && !(u.hostname === 'plug.dj' && u.path && (((ref$ = u.path) === '/about' || ref$ === '/team' || ref$ === '/partners' || ref$ === '/purchase' || ref$ === '/press' || ref$ === '/plot' || ref$ === '/ba' || ref$ === '/jobs' || ref$ === '/terms' || ref$ === '/privacy' || ref$ === '/subscribe') || ((ref$ = u.path[1]) === '@' || ref$ === '!')))) {
                target = '_self';
              } else {
                target = '_blank';
              }
    ...
    module('restoreChat', {
      ...
      help: "Restores the chat when reloading the page.\nNote: this will make closing the page a little bit slower, because it needs to store all the chat.",
      settings: 'chat',
      settingsSimple: true,
      require: ['LZString'],
      _settings: {},
      setup: function(){
        var html;
        this._settings.toJSON = this.save;
        if (this._settings.time > Date.now() - 1 .min && this._settings.room === getRoomSlug()) {
          html = LZString.decompress(this._settings.chat);
          if (this._settings.ad) {
            html = html.fastReplace(LZString.decompress(this._settings.ad), '');
          }
          get$cms().prepend(html);
        }
      },
      save: function(){
        var $cm, ref$;
        console.time('createdChatlog');
        $cm = get$cm();
        return {
          room: getRoomSlug(),
          ad: LZString.compress(((ref$ = chat.$chatMessages.children('.adsense')[0]) != null ? ref$.outerHTML : void 8) || ''),
          chat: LZString.compress(get$cm().html()),
          time: console.timeEnd('createdChatlog') || Date.now()
        };
      }
    });
    module('chatMacros', {
      setup: function(arg$){
        ...
        function fn$(c){
          var seperator, key, str;
          seperator = /\s/.exec(c + " ").index;
          key = c.substring(1, seperator);
          str = c.substr(seperator + 1);
          if (str[0] === "/") {
            str = " " + str;
          }
          API.sendChat(str + " " + map[key]);
        }
      }
    });
    ...
    */
    ...
    module('playlistIconView', {
      ...
      disableLate: function(){
        ...
        replace PlaylistItemList::, \onScroll, $.noop
        replace PlaylistItemList::, \drawList, !->
    ...
    module('draggableDialog', {
      ...
      settings: 'look&feel',
      setup: function(arg$){
        var addListener, replace, wrap, css, $dialog, startPos, startX, startY, $dialogContainer, lightsout, stopDragging;
        ...
        lightsout = true;
        replace(Dialog.prototype, 'getHeader', function(title){
          var x$;
    ...
    module('emojiPack', {
      ...
      packs: {
        apple: {
          name: "Apple (default)",
          sheet: 'https://i.imgur.com/GdaeoRa.png'
        },
        google: {
          name: "Google",
          sheet: 'https://i.imgur.com/hp3Skpx.png'
        },
        twitter: {
          name: "Twitter",
          sheet: 'https://i.imgur.com/m9pY70d.png'
        },
        emojione: {
          name: "EmojiOne",
          sheet: 'https://i.imgur.com/C2D66co.png'
        }
      },
      appleIcons: [],
      setup: function(arg$, emojiPack, module_){
        ...
        style = "#app .gemoji-plug {background-image: " + $span.css('background-image' || 'url(http://i.imgur.com/hgoulV4.png)') + ";}";
        $span.remove();
        for (packId in ref$ = this.packs) {
          pack = ref$[packId];
          style += ".p0-emoji-" + packId + " .emoji-inner {background-image: url(" + pack.sheet + ");}";
        }
        for (packId in ref$ = this.packs) {
          pack = ref$[packId];
          style += ".p0-emoji-" + packId + "-force .emoji-inner {background-image: url(" + pack.sheet + ");}";
        }
        css('emojiPack', style);
    ...
    module('roomSettings', {
      ...
      _update: function(){
        ...
        if (!(roomDescription = room.get('description'))) {
          ...
          console.log("[p0ne] " + roomThemeFormat + " Room Settings found", url[1]);
          this.roomThemeFormat = roomThemeFormat;
          $.getJSON(url[1]).then(function(data){
            var ref$, ref1$, ref2$;
            console.log(getTime() + " [p0ne] loaded " + roomThemeFormat + " Room Settings");
            ...
            if ((ref$ = data.colors) != null && ref$.chat) {
              ...
              delete data.colors.chat.residentdj, delete data.colors.chat.rdj;
              delete data.colors.chat.brandambassador, delete data.colors.chat['brand-ambassador'];
              ...
              delete data.colors.chat.background, delete data.colors.chat.header, delete data.colors.chat.footer;
            }
            if ((ref1$ = data.images) != null && ref1$.icons) {
              (ref2$ = data.images).background || (ref2$.background = data.images.icons.background);
              (ref2$ = data.images).playback || (ref2$.playback = data.images.icons.playback);
              delete data.images.icons.background;
              delete data.images.icons.playback;
            }
            data.emotes || (data.emotes = data.emoticons || data.emoji);
            delete data.emoticons, delete data.emoji;
            if (typeof ((ref2$ = data.css) != null ? ref2$['import'] : void 8) === 'string') {
    ...
    module('roomTheme', {
      ...
      setup: function(arg$){
        ...
        addListener(roomSettings, 'data', this.applyTheme = function(d){
          var cc, styles, role, ref$, color, colorMap, k, selector, rule, attrs, v, i$, len$, ref1$, name, url, res$, j$, len1$, u, x$, key, text, base, endKey;
          ...
          /*== emotes ==*/
          if (d.emotes && (typeof customEmoji != 'undefined' && customEmoji !== null)) {
            customEmoji.addEmoji(d.emotes);
          }
          if (d.autoEmotes && (typeof customEmoji != 'undefined' && customEmoji !== null)) {
    ...
    */
    ...
    module('customColors', {
      ...
      _settings: {
        ...
        */,
        ...
        /*  <uid>:
                ...
                defaultBadge: "â€¦"
                gRole: 0
                roles: <[ â€¦ â€¦ ]> # e.g. friend, subscriber, BA
                lastUsed: new Date(â€¦)
            */
      },
      roles: {
      ...
      getRoles: function(uid, user){
        var that, i$, ref$, len$, role, roomRole, ref1$, results$ = [], results1$ = [];
        if (that = getUser(uid)) {
    ...
    if (!window.p0ne) {
      ...
      for (id in ref$ = require.s.contexts._.defined) {
        ...
        if (m) {
          ...
          case !m.canModChat:
            window.user_ = m;
            for (i$ = 0, len$ = (ref7$ = ((ref8$ = m._events) != null ? ref8$['change:avatarID'] : void 8) || []).length; i$ < len$; ++i$) {
              ev = ref7$[i$];
              if (((ref9$ = ev.ctx) != null ? ref9$.comparator : void 8) === 'id') {
          ...
          case !m.prototype:
            switch (false) {
            case !(m.prototype.className === 'cell' && m.prototype.getBlinkFrame):
              (ref7$ = window.Cells)[ref7$.length] = m;
              break;
            case !(m.prototype.className === 'avatars' && m.prototype.eventName):
    ...
    module('customAvatars', {
      ...
      setup: function(arg$, customAvatars){
        ...
        p0ne._avatars = {};
        if (API.getUser().level < 5) {
          chatWarn("sorry, but Custom Avatars requires at least level 5", "Custom Avatars");
          this.disable();
        }
        ...
        */
        ...
        addListener(API, 'p0ne:socket:userUpdate', function(data){
          var ref$;
          if (data.avatarID) {
            user_.set('vanillaAvatarID', customAvatars._settings.vanillaAvatarID = data.avatarID);
            if (data.i === userID) {
      ...
      connect: function(url, reconnecting, reconnectWarning){
        ...
        this.socket.on('authToken', function(authToken){
          ...
          this$.changeBlurb(newBlurb, {
            ...
            error: function(){
              chatWarn("Failed to authenticate by changing the blurb. Are you a guest?", "p0ne avatars");
        ...
        this.socket.on('authAccepted', function(){
          ...
          this$.changeBlurb(this$.oldBlurb, {
            ...
            error: function(){
              chatWarn("failed to authenticate to avatar server. Are you a guest? Or maybe plug.dj is down or changed it's API?", "p0ne avatars");
              this$.changeBlurb(this$.oldBlurb, {
                error: function(){
        ...
        this.socket.on('authDenied', function(){
          ...
          chatWarn("Failed to authenticate as " + API.getUser().username + ".", "p0ne avatars");
          this$.disable();
        });
        ...
        this.socket.onclose = function(e){
          ...
          if (reconnect && !this$.disabled && !socket.isKill) {
    ...
    module('p0neSettings', {
      ...
      setup: function(arg$, p0neSettings, oldModule){
        ...
        $ppI = this.$ppI = $("<div class=p0ne-icon>p<div class=p0ne-icon-sub>0</div></div>").appendTo($ppM);
        ...
        this.$ppFooter = $("<div class=p0ne-settings-footer><div class=p0ne-icon>p<div class=p0ne-icon-sub>0</div></div><div class=p0ne-settings-version>v" + p0ne.version + "</div><i class='p0ne-settings-config-btn icon icon-p0ne-settings'></i><div class=p0ne-settings-help-btn>help</div><div class=p0ne-settings-modes><span class=p0ne-settings-mode data-mode=0>simple</span><span class=p0ne-settings-mode data-mode=1>advanced</span><span class=p0ne-settings-mode data-mode=2>programmer</span></div></div>").appendTo($ppS);
        for (i$ in ref$ = p0ne.modules) {
          module = ref$[i$];
          if (!module.loading) {
        ...
        $ppW.on('click', '.checkbox', throttle(200, function(e){
          ...
          console.info("[checkbox]", e, e.target);
          $this = $(this);
          enable = this.checked;
        ...
        $ppW.on('click', '.p0ne-settings-help', function(e){
          var left;
          console.info("[help]", e, $ppP, $ppP.css('left'));
          e.stopImmediatePropagation();
          helpClicked = true;
          _.defer(function(){
            helpClicked = false;
          ...
          if (p0neSettings.currSettingsPanelModule) {
            ...
            if (p0neSettings._settings.large) {
              console.info("[BOUNCEY]", $ppP, $ppP.css('marginTop'));
              $ppP.animate({
                marginTop: 20
              }, {
                duration: 100,
        ...
        addListener(API, 'p0ne:moduleDisabled', function(module_){
          var _$settingsExtra, ref$, ref1$;
          if (module_._$settings) {
            module_._$settings.removeClass('p0ne-settings-item-enabled').find('.checkbox:first').attr('checked', false);
            _$settingsExtra = (ref$ = module_._$settingsExtra) != null ? ref$.stop().slideUp(function(){
              _$settingsExtra.remove();
            }) : void 8;
            if ((ref1$ = module_._$settingsPanel) != null) {
              ref1$.wrapper.remove();
            }
      ...
      toggleAdvanced: function(mode){
        ...
        return this._settings.advanced = mode;
      },
      toggleLarge: function(state){
        ...
        if (state) {
          this.$ppW.addClass('p0ne-settings-large');
          this.$ppP.appendTo(this.$ppW);
          if (!this._settings.openGroup) {
            p0neSettings.openGroup('base');
          }
        } else {
          this.$ppW.removeClass('p0ne-settings-large');
          this.$ppP.appendTo(this.$ppM);
        }
        return this._settings.large = state;
      },
      ...
      setup: function(arg$){
        ...
        addListener(user_, 'change:role', function(user_, newRole){
          ...
          if (newRole > 1 && prevRole < 2) {
            ...
            $body.addClass('user-is-staff');
            user.isStaff = user_.isStaff = true;
            ...
            user.isStaff = user_.isStaff = false;
          }
          prevRole = newRole;
        });
      },
    ...
    module('disableChatDelete', {
      ...
      setup: function(arg$){
        ...
        function markAsDeleted(cid, mi){
          var ref$, $msg, ref1$, isLast, moderator, t, uid, ref2$, isValidDelete, ref3$, d, $cm;
          ...
          try {
            ...
            (d = $createPersistent(getTimestamp())).addClass('delete-timestamp').removeClass('timestamp').text("deleted " + (moderator ? 'by ' + moderator.username : '') + " " + d.first().text()).appendTo($msg);
            $cm = get$cm();
    ...
    module('afkTimer', {
      ...
      settingsExtra: function($wrapper){
        ...
        $el = $("<form><input type=range class=slider value=" + highlightOver + " min=1 max=240 step=1><input type=number class='number p0ne-settings-input afk-timer-max-min' /> min<br><label><input type=checkbox " + (this._settings.showCount ? 'checked' : '') + "> Show count in chat-toolbar</label></form>").on('input', '.slider', function(){
    ...
    */
    ...
    module('sandboxBackboneEvents', {
      ...
      setup: function(arg$){
        ...
        function offWarn(type, fn){
          if (!fn && type) {
            console.error("[" + this._name + "] warning: removing all listeners for " + type);
          }
    ...
    module('logGrabbers', {
      require: ['grabEvent'],
      setup: function(arg$){
        var addListener, grabbers, hasGrabber;
        addListener = arg$.addListener;
        grabbers = {};
        hasGrabber = false;
        addListener(API, 'p0ne:vote:grab', function(u){
    ...
    importAll$(window, {
      ...
      stringDiff: function(a, b){
        ...
        if (a.length > b.length) {
          console.info("1st string is longer than 2nd (" + a.length + " > " + b.length + ")");
        } else if (a.length < b.length) {
          console.info("1st string is shorter than 2nd (" + a.length + " < " + b.length + ")");
        }
        res = [];
        l = 1;
        a_ = "";
      ...
      fakeChat: function(message, user){
        ...
        if (typeof socketEvents != 'undefined' && socketEvents !== null) {
          socketEvents.chat({
            ...
            sub: user.sub,
            uid: user.id,
            un: "[FAKE] " + user.username
          });
        }
      }
    });
    if (typeof window.copy !== 'function') {
      $.getScript(p0ne.host + "/vendor/zclip/jquery.zclip.min.js").then(function(){
    ...
    */
    ...
    module('fimstats', {
      ...
      module: function(media){
        ...
        $.getJSON("https://fimstats.anjanms.com/_/media/" + media.format + "/" + media.cid).then(function(d){
          ...
          if (d.firstPlay.time !== d.lastPlay.time) {
            sinceFirstPlay = Date.now() - d.firstPlay.time * 1000;
            ...
            d.html = "<span class='p0ne-fimstats-field p0ne-fimstats-last p0ne-name' data-uid=" + d.lastPlay.id + "><span class=name>" + d.lastPlay.user.username + "</span><span class=p0ne-fimstats-last-time>" + ago(d.lastPlay.time * 1000) + "</span></span><span class='p0ne-fimstats-field p0ne-fimstats-first p0ne-name' data-uid=" + d.firstPlay.id + "><span class=name>" + d.firstPlay.user.username + "</span><span class=p0ne-fimstats-first-time>" + ago(d.firstPlay.time * 1000) + "</span></span><span class='p0ne-fimstats-field p0ne-fimstats-plays' title='" + playStats + "'>" + d.plays.total + "</span>";
          } else {
      ...
      settingsExtra: function($el, fimstats){
        var noReqMissing;
    ...
    return _.defer(function(){
      ...
      function moduleLoaded(m){
        ...
        if (--remaining === 0) {
          ...
          delete console.error_, delete console.warn_;
          console.groupEnd();
